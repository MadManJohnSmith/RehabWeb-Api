...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        TEAM_USERS = [
            ...
            {'username': 'quecholac', 'email': 'quecholac@ejemplo.com', 'password': '123456'},
        ]
        ...
        PATIENTS_TEMPLATE = [
            ...
            },
            {
                ...
                "adherence_range": (55, 75),
                "score_range": (Decimal("5.0"), Decimal("7.2")),
                "rom_progress": (60, 95),
        ...
        for t_data in TEAM_USERS:
            ...
            for p in PATIENTS_TEMPLATE:
                ...
                step(f"Asignado: {patient.full_name} ({p['status']})")
                ...
                for i in range(p["sessions_count"]):
                    ...
                    s = Session.objects.create(
                        ...
                        notes=rng.choice([
                            "Sin incidencias. Tolera carga progresiva.",
                            "Refiere dolor 2/10 al final de la sesión.",
                            "Mejora notable en rango articular.",
                            "Se reduce intensidad por fatiga muscular.",
                            "Excelente adherencia esta semana.",
                        ]),
                    )
                    sessions.append(s)
